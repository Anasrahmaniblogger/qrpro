    ...
    <div id="campaign-builder-modal" class="fixed inset-0 bg-black/60 hidden flex items-center justify-center z-[100] backdrop-blur-sm p-4 overflow-y-auto">
        <div class="bg-slate-50 w-full max-w-6xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto p-6 flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1 space-y-6">
                    ...
                    <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Image/Icon URL (Optional)</label>
                                    <input type="text" id="camp-image" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500" placeholder="https://..." onkeyup="updateCampaignPreview()">
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="camp-cta-action" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500" onchange="document.getElementById('camp-cta-url-container').classList.toggle('hidden', this.value !== 'url')">
                    ...
                    <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <select id="camp-trigger" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500" onchange="document.getElementById('camp-delay-container').classList.toggle('hidden', this.value !== 'time_delay')">
                ...
                <!-- Right: Preview -->
                <div class="w-full md:w-1/3 flex flex-col min-h-[400px]">
                    ...
                    <div class="bg-slate-200 rounded-xl flex-1 flex items-center justify-center relative overflow-hidden border-2 border-slate-300 border-dashed p-4" id="camp-preview-container">
                        ...
                        <div class="text-center text-slate-400 text-sm">
                            <i class="fas fa-eye text-3xl mb-2"></i><br>
...
// Insert the modal before the end of the body or just after some known modal
if (adminHtml.includes('<!-- User Override Modal -->')) {
    adminHtml = adminHtml.replace('<!-- User Override Modal -->', marketingModal + '\n    <!-- User Override Modal -->');
} else {
    adminHtml = adminHtml.replace('</body>', marketingModal + '\n</body>');
}
